...
| **Batch 03** | Barber Registration & Verification | Implementation of barber identity document submission wizard, admin verification queue hook, and verification status tracking (F-14, F-25). | Core MVP | Planned |
