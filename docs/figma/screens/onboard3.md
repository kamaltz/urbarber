...
- Purpose: Fourth onboarding/intro screen in a multi-step onboarding flow; presents a hero image, descriptive copy, a progress indicator, and a primary CTA.
...
- Hierarchy:
  ...
  - Hero image area: Picture (373 x 576, positioned at x=2, y=63)
  - Bottom content container: CONTAINERS (375 x 289)
    - Section Desc (339 x 226)
      - Title/Desc (339 x 128)
      - Slider (60 x 8)
      - Button/Big (339 x 54)
...
- Widths and heights:
  - Root: 375 x 812
  - Hero image area: 373 x 576
  - Bottom container: 375 x 289
  - Section Desc: 339 x 226
  - Title/Desc: 339 x 128
  - Slider: 60 x 8
  - CTA button: 339 x 54
...
- Typography:
  ...
  - CTA label: Plus Jakarta Sans Bold, 16 px
...
- Images: One large hero image asset is visible; the frame uses image-based onboarding visuals rather than simple colored blocks.
...
- Component name: Button/Big
  ...
  - Properties:
    - Fill: #d2691e
    - Text color: #FFFFFF
    - Text style: Plus Jakarta Sans Bold, 16 px
    - Width: 339 px
    - Height: 54 px
    - Corner radius: 8 px
